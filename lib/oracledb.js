...
async function _verifyOptions(options, inCreatePool) {
  ...
  // walletPEMContent must be a string
  if (options.walletPEMContent !== undefined) {
    errors.assertParamPropValue(typeof options.walletPEMContent === 'string', 1,
      "walletPEMContent");
    outOptions.walletPEMContent = options.walletPEMContent;
  }
  ...
  // tnsnamesContent must be a string
  if (options.tnsnamesContent !== undefined) {
    errors.assertParamPropValue(typeof options.tnsnamesContent === 'string',
      1, "tnsnamesContent");
    outOptions.tnsnamesContent = options.tnsnamesContent;
  }
