...
async function _verifyOptions(options, inCreatePool) {
  ...
  // walletKey must be a string
  if (options.walletKey !== undefined) {
    errors.assertParamPropValue(typeof options.walletKey === 'string', 1,
      "walletKey");
    outOptions.walletKey = options.walletKey;
  }
